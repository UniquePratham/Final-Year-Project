...
class AIAdapter:
    ...
    def _generate_anthropic(self, prompt: str, system_instruction: str) -> str:
        headers = {
            "Content-Type": "application/json",
    ...
    def _stream_anthropic(self, prompt: str, system_instruction: str) -> Generator[str, None, None]:
        headers = {
            "Content-Type": "application/json",
            "x-api-key": self.api_key,
            "anthropic-version": "2023-06-01"
